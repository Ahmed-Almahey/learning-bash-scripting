...
echo -e "\t\t🔮 \033[3;95mMYSTICAL SPHERE\033[0m 🔮"
echo

waitingnumber=$(( RANDOM % 3 ))
mysterynumber=$(( RANDOM % 10 ))
...
case $waintingnumber in
               ...
               3) sleep 1; echo "The veil of mystrey is dark today..."; sleep 3;;
esac
echo 
